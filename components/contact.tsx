  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-xl p-8 shadow-lg max-w-[50%] mx-auto relative overflow-hidden">
          {/* Floating Circles */}
          ...
          <div className="max-w-2xl mx-auto relative z-10 selection:bg-black/30">
            <form className="space-y-6">
              ...
              <label
                htmlFor="name"
                className="block text-xl mb-2 terminal-text text-[#1E1E1E]"
              >
                Name_
              </label>
              <input
                type="text"
                id="name"
                className="w-full p-4 rounded-xl bg-[#D35F0C]/30 text-[#1E1E1E] terminal-text focus:outline-none placeholder:text-[#636262]"
            ...
            <button
              type="submit"
              className="w-full p-4 bg-[#2a2a2a] text-white terminal-text hover:bg-[#1f1e1e] rounded-xl transition-colors cursor"
            >
                Send_Message
              </button>
            </form>
